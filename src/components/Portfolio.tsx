...
const defaultSkillGroups = [
  {
    ...
    items: ["Meta Ads", "Lead Generation", "Lead Nurturing", "Social Media Mgmt", "Community Mgmt", "Email Marketing", "Content Marketing", "Prospection B2B"],
  },
  {
    icon: Sparkles,
    title: "Intelligence Artificielle",
    items: ["ChatGPT", "Claude AI", "Higgsfield AI"],
  },
  {
    icon: Code2,
    title: "Développement Web",
    items: ["HTML", "CSS", "JavaScript", "Tailwind CSS", "Sites Web & Landing Pages (Claude AI)"],
  },
  {
    icon: Palette,
    title: "Design Graphique",
    items: ["Identité visuelle", "Publicités digitales", "Catalogues"],
  },
];
...
const defaultTools = [
  ...
  {
    name: "Illustrator",
    svg: "M15.2 3H20v16h-4.8V3zM6.8 3H12v16H6.8V3zM1.6 3h3.2v16H1.6V3z",
  },
  {
    name: "Premiere Pro",
